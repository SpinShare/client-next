    ...
    <section class="chart-detail-tab-overview">
        ...
        <div class="details">
            <div class="item">
                ...
                <div class="label">
                    {{ t('chart.detail.overview.views.label') }}
                </div>
            </div>
            <div class="item">
                ...
                <div class="label">
                    {{ t('chart.detail.overview.downloads.label') }}
                </div>
            </div>
            <div class="item">
                ...
                <div class="value">
                    {{
                        isExplicit
                            ? t(
                                  'chart.detail.overview.explicit.explicitContent',
                              )
                            : t(
                                  'chart.detail.overview.explicit.noExplicitContent',
                              )
                    }}
                </div>
                <div class="label">
            ...
            <div class="item">
                ...
                <div class="label">
                    {{ t('chart.detail.overview.lastUpdate.label') }}
                </div>
            </div>
        </div>
        <div
...
const relativeUpdateDate = computed(() =>
    props.updateDate
        ? moment(props.updateDate?.date).startOf('minute').fromNow()
        : 'Never',
);
