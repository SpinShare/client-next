...
APP_URN_ROOT="re.spinsha"
APP_URN="$APP_URN_ROOT.$APP_NAME_LCD"

APP_MAINTAINER="SpinShare <wearespinshare@gmail.com>"
APP_DESC_SHORT="SpinShare"
APP_DESC_LONG="A modern cross-platform custom chart client for SpinShare"

# Set project options
PROJECT_NAME="SpinShareClient"
PROJECT_ROOT=$(pwd)/..
PROJECT_DIR="$PROJECT_ROOT/$PROJECT_NAME"

# Set publish options
PUBLISH_CONFIG="Release"
PUBLISH_PLATFORMS="win-x64 linux-x64"
